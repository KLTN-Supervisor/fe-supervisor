    ...
    <div style={{display: "flex", justifyContent: "center"}}>
      <div style={{width: 900}} ref={componentRef} >
        ...
        <div style={{marginLeft: 40}}>
          <span>Phòng thi: </span>
          <span style={{fontWeight: "bold", marginRight: 20}}>{info.room_name}</span>
          <span>Ca thi: </span>
          <span style={{fontWeight: "bold"}}>{formatHour(info.start_time)}</span>
        </div>
        <div style={{display: "flex", justifyContent:"center", marginTop: 20 }}>
            <span style={{fontFamily: "Tahoma",
                          fontSize: "14px",
        ...
        <div>
          <span style={{fontFamily: "Tahoma",
            ...
            fontWeight: "bold",
            marginLeft: 50,
            color: "#0051C6"}}>HK0{info.term}/{info.year?.from}-{info.year?.to}</span>
        </div>
        <div style={{display: "flex", justifyContent: "center"}}>
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
              ...
              {students.map((student) => (
                  <StyledTableRow key={student.student.student_id}>
                    ...
                    <StyledTableCell align="right">{student.student.last_name +
                            " " +
                            student.student.middle_name +
                            " " +
                            student.student.first_name}</StyledTableCell>
                    <StyledTableCell align="right">{student.attendance ? "Có mặt" : "Vắng thi"}</StyledTableCell>
