          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{alignTtems: "center", display: "flex"}}>Quyền <Dropdown>
                  <MenuButton><FilterAltIcon/></MenuButton>
                  <Menu slots={{ listbox: AnimatedListbox }}>
                    <MenuItem key={1} onClick={createHandleMenuClick('Inpector')}>Thanh tra</MenuItem>
                    <MenuItem key={2} onClick={createHandleMenuClick('admin')}>
                      Quản trị
                    </MenuItem>
                    <MenuItem key={3} onClick={createHandleMenuClick('pdt')}>Phòng đào tạo</MenuItem>
                  </Menu>
                </Dropdown></TableCell>
